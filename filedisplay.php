    ...
    <div class="container-fluid mt-5">
        <div class="container">
            <table class="table table-striped table-bordered" id="example" style="width:100%">
                ...
                <tbody>
                    <?php
                    $sql2 = "SELECT * FROM aadfiles WHERE departmentname='$name'";
                    $show = mysqli_query($con, $sql2);
                    foreach ($show as $s) {
                    ?>
                        <tr>
                            <td><?php echo $s['title'] ?></td>
                            <td><a href="./admincontrol/uploads/<?php echo $s['filename'];?>"readfile="<?php echo $s['filename'];?>"><?php echo $s['filename'];?></a></td>
